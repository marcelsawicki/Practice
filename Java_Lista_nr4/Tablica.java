public class Tablica { //tworze klase tablica
    ...
    public int[] utworz(){ //getter - metoda odczytujaca stan obieku, ta metoda tworzy tablice o liczbie elementow "ilosc"
      ...
      this.tabl=new int[this.ilosc]; //tworze obiekt tablicowy o liczbie elementow "ilosc", czy potrzebne jest tu slowo "this"?
    ...
    public void suma(){ //ta metoda sumuje elementy tablicy
        ...
        for(int i=0;i<this.tabl.length;i++){
            ...
            System.out.println(sum); //czy lepiej moze zrobic "return sum;" wtedy mam getter
    }
