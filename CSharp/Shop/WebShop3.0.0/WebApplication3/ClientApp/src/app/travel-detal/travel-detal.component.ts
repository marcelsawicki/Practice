...
@Component({
  selector: 'travel-detal-data',
  templateUrl: './travel-detal.component.html'
})
export class TravelDetalComponent {
  ...
  constructor(http: HttpClient, @Inject('BASE_URL') baseUrl: string, router: Router, private route: ActivatedRoute) {
    ...
    this.routeSub = this.route.params.subscribe(params => {
      ...
      http.get<Fruitdetail[]>(baseUrl + 'travelaccessories/' + this.itemno).subscribe(result => {
